  ...
  return (
    <div>
      <div className="container">
        ...
        Si bien la victoria puede parecer obvia sin poner el último símbolo, se
        necesita que quede asentado en el tablero para determinar al ganador.{" "}
        <br />
        Sólo podrá jugar en su turno
        <br />
        <br />
        <b>
          ¿Listo? ¿Entendimos eso? ¡Perfecto! Así que ahora veamos qué hay que
          hacer para jugar.
        </b>
        Haga click en crearSala para crear una nueva sala y envie el link a su
        amigue o compañere <br />
        Si, por el contrario, alguien le envió un link, pongalo en su navegador
        para entrar a la sala (felicidades, es el círculo) <br />
        <br />
