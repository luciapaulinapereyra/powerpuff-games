...
const urlJoin = `${URL_FRONT}/rpsls/rooms/join/`;
const url = `${BASE_URL}/rpsls/rooms/`;
...
const RoomRpsls = (props) => {
  ...
  return (
    <div>
      ...
      <div className="title">
        <h1>SALA DE PIEDRA, PAPEL, TIJERA, LAGARTO, SPOCK!</h1>
      </div>
      <div className="paragraph">
        <h3>
          Usted esta en la room{" "}
      ...
      <div className="title">
        <LastWinner lastWinner={lastWinner} />
      </div>
